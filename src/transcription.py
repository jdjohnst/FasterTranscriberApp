...
SUMMARY_PROMPTS = {
    ...
    "Meeting / Group Discussion": {
        "chunk": "Act as a meticulous meeting secretary and historical record keeper. Extract all core tensions, diverse perspectives, dissenting opinions, finalized decisions, and specific action items (with owner and deadline). Capture nuanced details of the consensus-building process.",
        "combine": "Generate a structured summary that balances formal outcomes with the underlying nuances of sensitive deliberations. Prioritize a neutral, 'historical record' style.\n1. Meeting Overview (capture the consensus-building process)\n2. Agenda Items Analysis (synthesize core tensions, diverse perspectives, and dissenting opinions for each topic)\n3. Finalized Decisions & Rationales\n4. Commitments: [Owner] | [Actionable Deliverable] | [Deadline]"
    },
